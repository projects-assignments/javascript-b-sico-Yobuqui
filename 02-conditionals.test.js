...
describe("Condicionales en JavaScript", () => {
    it("Completa el valor del resultado de la aserción para que pase el test", () => {
        ...
        //////////Nota: Se usa una declaración if para verificar si la longitud de name es mayor o igual a 6. Si es así, se actualiza el valor de result a "Lara tiene un nombre largo". La función assert.strictEqual() tiene que verificar que result sea igual a "Lara tiene un nombre corto". Si result no es igual a "Lara tiene un nombre corto", el test fallará. 
    ...
    it("Completa el valor de la aserción", () => {
        ...
        // Edita el assert (los "???") para que pase el test
        // En este caso, la condición es age >= 18. Si age es mayor o igual a 18, se ejecutará el código dentro del bloque if. De lo contrario, se ejecutará el código dentro del bloque else.
    ...
    it("Completa el valor de la aserción", () => {
        ...
        // Edita el assert (los "???") para que pase el test
        //////////Nota: verificar si number es divisible por 7 y actualiza el valor de result en consecuencia. Si number es divisible por 7, result será igual a Pizza con pepperoni. De lo contrario, result será igual a Pizza con piña.
